...
<template>
  <div class="min-h-screen bg-gradient-to-br from-red-100 via-gray-100 to-red-200 py-12 px-4 pt-28 sm:pt-32">
    <div class="w-full max-w-md mx-auto bg-white rounded-lg shadow p-6 sm:p-8">
      <h1 class="text-xl sm:text-2xl font-bold text-center text-red-700 mb-6 tracking-wide">Ordene su comida</h1>
